...
function calculate() {
    ...
    const m_quantity = parseInt(document.getElementById('m_quantity').value) || 0;
    console.log('m_quantity: ' + m_quantity);
    const f_quantity = parseInt(document.getElementById('f_quantity').value) || 0;
    ...
    return sum_total; // Return the total value
}
